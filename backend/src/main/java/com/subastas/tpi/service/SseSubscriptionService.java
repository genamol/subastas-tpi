...
public interface SseSubscriptionService {
    ...
    void emitirPujaAdmin(Long subastaId, @NonNull PujaAdminSseDto datosCompletos);
    ...
    SseEmitter suscribirNotificaciones(Long userId);
    void emitirNotificacion(Long userId, @NonNull NotificacionResponse notificacion);
    void removerNotificacionesPorUsuario(Long userId);
}
